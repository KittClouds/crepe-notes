...
/// ResoRank configuration with BM25F + Proximity + BM𝒳 parameters
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResoRankConfig {
    ...
    /// Weight for entropy in denominator (γ). If None, auto-calculated as α/2.
...
impl ResoRankConfig {
    ...
    /// BM𝒳 with entropy only (conservative adoption)
