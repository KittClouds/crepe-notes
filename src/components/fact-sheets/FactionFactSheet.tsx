...
interface FactionFactSheetProps {
  entity: ParsedEntity;
  onUpdate: (attributes: EntityAttributes) => void;
}

export function FactionFactSheet({ entity, onUpdate }: FactionFactSheetProps) {
  ...
  return (
    <div className="p-3 space-y-3 pb-20">
      <div className="text-center pb-2 border-b border-border/50">
        <span className="text-xs font-mono text-muted-foreground">FACTION</span>
