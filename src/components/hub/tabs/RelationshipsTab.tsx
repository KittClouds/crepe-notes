// src/components/hub/tabs/RelationshipsTab.tsx
// Ported from legacy_v1/src/features/blueprint-hub/components/tabs/RelationshipTypesTab.tsx
// Entity-First Relationship Manager with graphical entity node interface
...
export function RelationshipsTab({ isLoading: _isLoading }: RelationshipsTabProps) {
    ...
    return (
        <div className="h-full">
            {parsedEntity ? (
                <EntityRelationshipsView entity={parsedEntity} />
            ) : (
