...
// Stub for missing embeddings library
const EmbeddingModelRegistry = {
    getLocalModels: () => [
        { id: 'xenova/all-MiniLM-L6-v2', name: 'all-MiniLM-L6-v2 (Default)' },
        { id: 'xenova/bge-small-en-v1.5', name: 'bge-small-en-v1.5' }
    ],
    getCloudModels: () => [
    ...
    getModel: (id: string) => ({
        description: 'Stub description for ' + id,
        dimensions: 384,
        costPer1kTokens: 0
    })
};
...
export function SettingsPanel({ open, onOpenChange }: SettingsPanelProps) {
    ...
    const [folderViewTheme, setFolderViewTheme] = useState(settings.appearance?.folderViewTheme || 'default');
